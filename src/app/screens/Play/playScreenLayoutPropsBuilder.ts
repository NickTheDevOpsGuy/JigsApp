...
interface PlayScreenLayoutArgs {
  ...
  state: import("@/puzzle/types").PuzzleState | null;
  ...
  viewport: { viewport: import("./hooks/useViewport").ViewportState };
  ...
  manager: import("@/puzzle/PuzzleManager").PuzzleManager | null;
  trayRef: React.RefObject<HTMLDivElement>;
  trayPieces: import("@/puzzle/types").Piece[];
  ...
  dragPreviewPiece: import("@/puzzle/types").Piece | null;
  ...
  perfStatsRef: React.MutableRefObject<import("./components/ProfilerOverlay").PerfStats | null>;
}
