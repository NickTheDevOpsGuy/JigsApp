...
import type { BuildHeaderMenuPropsArgs } from "./usePlayScreenTopBarPropsBuilders.types";
import { buildHeaderMenuToggleProps } from "./usePlayScreenTopBarMenuToggles";
...
export function buildHeaderMenuProps(args: BuildHeaderMenuPropsArgs): HeaderMenuProps {
  ...
  return {
    ...
    showEdgeHighlight,
    showClusterOutline,
    onToggleClusterOutline: () => { if (hapticsEnabled && typeof navigator?.vibrate === "function") navigator.vibrate(10); onToggleClusterOutline(); },
    deliberateDetachEnabled,
    onToggleDeliberateDetach: () => { if (hapticsEnabled && typeof navigator?.vibrate === "function") navigator.vibrate(10); onToggleDeliberateDetach(); },
    showAlignmentGrid,
    isFullscreen,
