...
import { SnapComboMeter } from "./SnapComboMeter";
...
type PlayScreenLayoutProps = {
  ...
  replayPortalProps: React.ComponentProps<typeof ReplayBar> | null;
  board: {
    ...
    viewport: {
      ...
      >;
      handleWheel: (e: React.WheelEvent<HTMLCanvasElement>, boardEl: HTMLDivElement | null) => void;
    };
    handlers: {
  ...
  return (
    <PlayScreenCoopView {...coopViewProps}>
      ...
      >
        ...
        {replayPortalProps &&
          createPortal(<ReplayBar {...replayPortalProps} />, document.body)}
            ...
            <div className={styles.boardWrapper}>
              ...
              >
                ...
                >
                  ...
                  {board.isPaused && <PauseOverlay onResume={board.onResume} />}
                </div>
              </div>
            </div>
          </div>
