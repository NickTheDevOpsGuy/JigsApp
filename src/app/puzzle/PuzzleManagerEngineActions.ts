...
export class PuzzleManagerActions extends PuzzleManagerState {
  ...
  getSnapPreviewState(): { nearSnap: boolean; inSnapRange: boolean; proximity: number } | null {
  ...
  protected getEffectiveBoardSnapTolerance(multiplier = 1): number {
    return getEffectiveTolerance(this.snapToleranceBoardPx, this.getToleranceOptions(), multiplier);
  }
