...
import type { EffectiveToleranceOptions } from "@/puzzle/manager/state/puzzleManagerUtils";
...
export function trySnapMergedGroupToBoardOp(params: SnapMergedToBoardParams): void {
  ...
  const result = computeMergedGroupBoardSnapResult(pieces, groupId, overlapEpsilonPx);
