...
export const BOARD_MAGNET_RADIUS_PX = 52;
export const BOARD_MAGNET_STRONG_RADIUS_PX = 28;
export const EDGE_MAGNET_RADIUS_PX = 44;
export const EDGE_MAGNET_STRONG_RADIUS_PX = 22;
