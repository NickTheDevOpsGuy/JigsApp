...
- `npm run test:e2e:smoke` runs high-signal flows across Chrome, Firefox, Safari/WebKit, and Edge-compatible Chromium.
- `npm run test:e2e:layouts` runs responsive iPhone, iPad, and Android tablet projects.
